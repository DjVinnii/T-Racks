        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('ipv6_network.create') }}" class="btn btn-app">
    ...
    <script type="text/javascript">
        $(function () {
            $('#datatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('ipv6_network.datatable') !!}',
                columns : [
                    { data: 'name' , name: 'name' },
                    { data: 'network' , name: 'network' },
                    { data: function(e) {
                            let returnval = '';
                            let view = '{{ route('ipv6_network.show', -1) }}'.replace('-1', e.id);
                            let edit = '{{ route('ipv6_network.edit', -1) }}'.replace('-1', e.id);
